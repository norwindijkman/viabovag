...
export default function Navbar() {
  return (
    <div className="tw-relative">
      <button className="tw-w-10 tw-h-10 tw-justify-items-center">
      ...
      <div className="tw-absolute tw-top-0 tw-right-0 tw-bg-[#E74C3C] tw-w-4 tw-h-4 tw-text-[.75rem] tw-justify-items-center tw-text-center tw-text-white tw-rounded-full">
        2
      </div>
    </div>
  );
