        ...
        <div className="tw-bg-white tw-border tw-border-black tw-w-80">
          <div className="tw-relative tw-px-4 tw-pt-4">
            ...
            <p className="tw-text-foreground-light tw-mb-8">
              Bewaar je persoonlijke collectie van favoriete camera&lsquo;s en lenzen
            </p>
              ...
              <div key={product.id}>
                <div className="tw-grid tw-grid-cols-3 tw-gap-4">
                  ...
                  <div className="tw-col-span-2">
                    <div>
                      <a href="#" className="tw-mb-1 tw-font-semibold tw-text-foreground hover:tw-text-primary-light">{product.name.replace(product.brand, '')}</a>
                    </div>
